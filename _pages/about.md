...
추가할 것 : cv 2문단 줄이기0, 각 연구실 타겟으로 특정 질병 극복하는 식으로 세부 목표와 가서 할 것들 정리한 추가 ppt를 작성해서 동봉(해당 연구실 기술, 제공할 수 있는 기술, 앞으로 배워서 적용해보고 싶은 기술 > 벤다이어그램 같은 관계도로 예쁘게 시각화하기), project 따본 경험(직접 제안서 보고서 작성 경험 다수 보유) 있음 어필0, 그랜트 딸 수 있는 것 정리해서 몇월에 지원할 예정이고 딸 수 있음을 보여주는 표를 ppt에 동봉하면 좋음, 연구실 특화 research proposal 작성.
